...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | GANTI PASSWORD</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK GANTI PASSWORD" />
													...
													<?php
														if (isset($_POST['simpan'])==true){
															...
															if($pass1 != $pass2){
																...
																$update = mysql_query("UPDATE agen SET pass_agen=PASSWORD('$pass1') WHERE id_agen='$id_agen'");
																if($update){

...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | MENU KELOLA PENGGUNA JASA</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK MENU KELOLA PENGGUNA JASA" />
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Data Pengguna Jasa</h6>
									</div>
									<div class="clearfix"></div>
								</div>
							<?php
								$get_peg = mysql_query("SELECT * FROM agen");
							?>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<a href="inputagen.php"><button class="btn btn-primary">Tambah Pengguna Jasa Baru</button></a>
									<br>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														<td><?php echo $data_peg['id_agen'];?></td>
														<td><?php echo $data_peg['nama_agen'];?></td>
														<td><a href="editagen.php?id=<?php echo $data_peg['id_agen']; ?>"><img src="dist/img/icons8-overview-64.png" width="32px"></a></td>
														<td><form method="post" action="#" onsubmit="disp_confirm()">
                <a href="hapus.php?ida=<?php echo $data_peg['id_agen']; ?>" style="text-decoration:none" onclick="return disp_confirm();"><img src="dist/img/icons8-delete-shield-64.png" width="32px"></a>
                </form></td>
													</tr>
													<?php }?>
												</tbody>

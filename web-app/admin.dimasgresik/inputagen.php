...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | TAMBAH PENGGUNA JASA BARU</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK TAMBAH PENGGUNA JASA BARU" />
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Tambah Pengguna Jasa Baru</h6>
									</div>
												...
												<div class="form-group mb-0"> 
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															if($id != "" && $nama != ""){
																$insert = mysql_query("INSERT INTO agen VALUES('$id', '$nama', PASSWORD('123456'))");
																if($insert){
																	echo '<script language="javascript">alert("Pengguna Jasa baru berhasil ditambahkan! Password: 123456");document.location="menuagen.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Pengguna Jasa gagal ditambahkan!");</script>';
																}
															}
															else{

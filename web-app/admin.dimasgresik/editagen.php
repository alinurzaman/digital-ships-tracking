...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | EDIT DATA PENGGUNA JASA</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK EDIT DATA PENGGUNA JASA" />
    ...
    <div class="wrapper theme-1-active pimary-color-blue">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="menuagen.php" class="active"><div class="pull-left"><i class="zmdi zmdi-account mr-20"></i><span class="right-nav-text">Kelola Pengguna Jasa</span></div><div class="clearfix"></div></a>
				</li>
				<li>
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Edit Data Pengguna Jasa</h6>
									</div>
										...
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="create">
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="id">ID Pengguna Jasa:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="id" placeholder="Maksimum 12 karakter" style="text-transform: uppercase" maxlength="12" value="<?php echo $data_agen['id_agen']; ?>">
												</div>
												</div>
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="nama">Nama Pengguna Jasa:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="nama" value="<?php echo $data_agen['nama_agen']; ?>">
												</div>
												</div>
												<div class="form-group mb-0"> 
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															$idlama = $data_agen['id_agen'];
															$nama = strtoupper($_POST['nama']);
															if($id != "" && $nama != ""){
																$update = mysql_query("UPDATE agen SET id_agen='$id', nama_agen='$nama' WHERE id_agen='$idlama'");
																if($update){
																	echo '<script language="javascript">alert("Data pengguna jasa berhasil diubah!");document.location="menuagen.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Data pengguna jasa gagal diubah!");</script>';
																}
															}
															else{

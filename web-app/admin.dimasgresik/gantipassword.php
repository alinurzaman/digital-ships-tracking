...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | GANTI PASSWORD PEGAWAI</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK GANTI PASSWORD PEGAWAI" />
    ...
    <div class="wrapper theme-1-active pimary-color-blue">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="inputagen.php"><div class="pull-left"><i class="zmdi zmdi-account-add mr-20"></i><span class="right-nav-text">Tambah Pengguna Jasa</span></div><div class="clearfix"></div></a>
				</li>
				<li>
				...
				<li>
					<a href="inputpegawai.php"><div class="pull-left"><i class="zmdi zmdi-accounts-add mr-20"></i><span class="right-nav-text">Tambah Pegawai</span></div><div class="clearfix"></div></a>
				</li>
				<li>
					<a href="inputlokasi.php"><div class="pull-left"><i class="zmdi zmdi-boat mr-20"></i><span class="right-nav-text">Tambah Lokasi Sandar</span></div><div class="clearfix"></div></a>
				</li>
				<li>
										...
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="change">
												<div class="form-group">
													<label class="control-label mb-10 col-sm-4" for="pass1">Password Baru:</label>
												<div class="col-sm-6">
													<input type="password" class="form-control" name="pass1" id="pass1" >
												</div>
												</div>
												<div class="form-group">
													<label class="control-label mb-10 col-sm-4" for="pass2">Ulangi Password Baru:</label>
												<div class="col-sm-6"> 
												...
												<div class="form-group mb-0"> 
													<div class="col-sm-offset-4 col-sm-10">
													  <button name="simpan" type="submit" class="btn btn-primary btn-anim"><i class="icon-rocket"></i><span class="btn-text">Simpan</span></button>
													</div>
												</div>
												</form>
													<?php
														if (isset($_POST['simpan'])==true){
															...
															if($pass1 != $pass2){
																...
																$update = mysql_query("UPDATE pegawai SET pass_pegawai=PASSWORD('$pass1') WHERE id_pegawai='$id_pegawai'");
																if($update){

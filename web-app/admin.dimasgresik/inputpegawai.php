...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | TAMBAH PEGAWAI BARU</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK TAMBAH PEGAWAI BARU" />
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Tambah Pegawai Baru</h6>
									</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="create">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" name="id" style="text-transform: uppercase" maxlength="18">
												</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group mb-0"> 
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															if($id != "" && $nama != ""){
																$insert = mysql_query("INSERT INTO pegawai VALUES('$id', '$role', '$nama', PASSWORD('123456'))");
																if($insert){
																	echo '<script language="javascript">alert("Pegawai baru berhasil ditambahkan! Password: 123456");document.location="menupegawai.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Pegawai baru gagal ditambahkan!");</script>';
																}
															}
															else{

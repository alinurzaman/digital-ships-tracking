...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | TAMBAH LOKASI SANDAR BARU</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK TAMBAH LOKASI SANDAR BARU" />
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Tambah Lokasi Sandar Baru</h6>
									</div>
												...
												<div class="form-group mb-0"> 
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															if($nama != "" && $alamat != ""){
																$insert = mysql_query("INSERT INTO lokasi VALUES(NULL, '$nama', '$alamat')");
																if($insert){
																	echo '<script language="javascript">alert("Lokasi baru berhasil ditambahkan!");document.location="menulokasi.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Lokasi baru gagal ditambahkan!");</script>';
																}
															}
															else{

						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Laporan Belum Diproses</h6>
									</div>
									<div class="clearfix"></div>
								</div>
							<?php
								$get_laporan = mysql_query("SELECT id_laporan, tanggal_laporan, sarana_laporan, bendera_laporan, B.nama_lokasi, tanggaleta_laporan, eta_laporan, tanggaletb_laporan, etb_laporan, kategori_laporan, muatan_laporan, impor_laporan, approve_laporan, C.nama_agen FROM laporan AS A INNER JOIN lokasi AS B ON A.id_lokasi = B.id_lokasi INNER JOIN agen AS C ON A.id_agen = C.id_agen WHERE bc10_laporan IS NULL OR bc11_laporan IS NULL OR filerute_laporan IS NULL");
							?>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php if($data_laporan['approve_laporan']=='1'){ ?>
															<a href="proseslaporan.php?idl=<?php echo $data_laporan['id_laporan'];?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Proses</span></button></a>
															<?php } else {?>
															<a href="approvelaporan.php?idl=<?php echo $data_laporan['id_laporan'];?>"><button class="btn btn-info btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Approve</span></button></a>
															<?php } ?>
														</td>
													</tr>
													<?php }?>

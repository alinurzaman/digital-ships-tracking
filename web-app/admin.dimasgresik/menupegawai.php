...
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | MENU KELOLA PEGAWAI</title>
				...
				<!-- Row -->
					<div class="row">
						<div class="col-md-12">
							...
							<?php
								$get_peg = mysql_query("SELECT * FROM pegawai");
							?>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<a href="inputpegawai.php"><button class="btn btn-primary">Tambah Pegawai Baru</button></a>
									<br>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														<td><?php echo $data_peg['id_pegawai'];?></td>
														<td><?php echo $data_peg['nama_pegawai'];?></td>
														<td><?php echo $data_peg['role_pegawai'];?></td>
														<td><a href="editpegawai.php?id=<?php echo $data_peg['id_pegawai']; ?>"><img src="dist/img/icons8-overview-64.png" width="32px"></a></td>
														<td><form method="post" action="#" onsubmit="disp_confirm()">
                <a href="hapus.php?idp=<?php echo $data_peg['id_pegawai']; ?>" style="text-decoration:none" onclick="return disp_confirm();"><img src="dist/img/icons8-delete-shield-64.png" width="32px"></a>
                </form></td>
													</tr>
													<?php }?>
												</tbody>

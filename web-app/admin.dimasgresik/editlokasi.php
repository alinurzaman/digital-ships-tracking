...
ob_start();
	...
	if(($_SESSION['sudahloginadmin']==true)&&($_SESSION['role']=='ADMIN')){
		...
		$id_lokasi = $_GET['id'];
		$get_lokasi = mysql_query("SELECT * FROM lokasi WHERE id_lokasi='$id_lokasi'");
		$data_lokasi = mysql_fetch_array($get_lokasi);
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<title>DIGITAL MENGAWASI BC GRESIK | EDIT DATA LOKASI SANDAR</title>
	<meta name="description" content="DIGITAL MENGAWASI BC GRESIK EDIT DATA LOKASI SANDAR" />
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Edit Data Lokasi Sandar</h6>
									</div>
										...
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="create">
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="nama">Nama Lokasi:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="nama" value="<?php echo $data_lokasi['nama_lokasi']; ?>">
												</div>
												</div>
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="nama">Alamat:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="alamat" value="<?php echo $data_lokasi['alamat_lokasi']; ?>">
												</div>
												</div>
												<div class="form-group mb-0"> 
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															if($nama != "" && $alamat != ""){
																$update = mysql_query("UPDATE lokasi SET nama_lokasi='$nama', alamat_lokasi='$alamat' WHERE id_lokasi='$id_lokasi'");
																if($update){
																	echo '<script language="javascript">alert("Data lokasi sandar berhasil diubah!");document.location="menulokasi.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Data lokasi sandar gagal diubah!");</script>';
																}
															}
															else{
